...
var cockroachdbMetrics = map[string]string{
	...
	"admission_admitted_elastic_stores_bulk_low_pri":                      "admission.admitted.elastic_stores.bulk_low_pri",
	...
	"admission_admitted_kv_stores_user_high_pri":                          "admission.admitted.kv_stores.user_high_pri",
	...
	"admission_errored_elastic_stores_bulk_low_pri":                       "admission.errored.elastic_stores.bulk_low_pri",
	...
	"admission_errored_kv_stores_user_high_pri":                           "admission.errored.kv_stores.user_high_pri",
	...
	"admission_requested_elastic_stores_bulk_low_pri":                     "admission.requested.elastic_stores.bulk_low_pri",
	...
	"admission_requested_kv_stores_user_high_pri":                         "admission.requested.kv_stores.user_high_pri",
	...
	"admission_wait_durations_elastic_stores_bulk_low_pri":                "admission.wait_durations.elastic_stores.bulk_low_pri",
	"admission_wait_durations_elastic_stores_bulk_low_pri_bucket":         "admission.wait_durations.elastic_stores.bulk_low_pri.bucket",
	"admission_wait_durations_elastic_stores_bulk_low_pri_count":          "admission.wait_durations.elastic_stores.bulk_low_pri.count",
	"admission_wait_durations_elastic_stores_bulk_low_pri_sum":            "admission.wait_durations.elastic_stores.bulk_low_pri.sum",
	...
	"admission_wait_durations_kv_bucket":                                  "admission.wait.durations.kv.bucket",
	"admission_wait_durations_kv_bulk_normal_pri":                         "admission.wait_durations.kv.bulk_normal_pri",
	"admission_wait_durations_kv_count":                                   "admission.wait.durations.kv.count",
	...
	"admission_wait_durations_kv_stores_bucket":                           "admission.wait.durations.kv_stores.bucket",
	"admission_wait_durations_kv_stores_bulk_normal_pri":                  "admission.wait_durations.kv_stores.bulk_normal_pri",
	"admission_wait_durations_kv_stores_count":                            "admission.wait.durations.kv_stores.count",
	...
	"admission_wait_durations_kv_stores_sum":                              "admission.wait.durations.kv_stores.sum",
	"admission_wait_durations_kv_stores_ttl_low_pri":                      "admission.wait_durations.kv_stores.ttl_low_pri",
	"admission_wait_durations_kv_stores_user_high_pri":                    "admission.wait_durations.kv_stores.user_high_pri",
	"admission_wait_durations_kv_stores_user_high_pri_bucket":             "admission.wait_durations.kv_stores.user_high_pri.bucket",
	"admission_wait_durations_kv_stores_user_high_pri_count":              "admission.wait_durations.kv_stores.user_high_pri.count",
	"admission_wait_durations_kv_stores_user_high_pri_sum":                "admission.wait_durations.kv_stores.user_high_pri.sum",
	"admission_wait_durations_kv_sum":                                     "admission.wait.durations.kv.sum",
	"admission_wait_durations_snapshot_ingest":                            "admission.wait_durations.snapshot_ingest",
	"admission_wait_durations_snapshot_ingest_bucket":                     "admission.wait_durations.snapshot_ingest.bucket",
	"admission_wait_durations_snapshot_ingest_count":                      "admission.wait_durations.snapshot_ingest.count",
	"admission_wait_durations_snapshot_ingest_sum":                        "admission.wait_durations.snapshot_ingest.sum",
	"admission_wait_durations_sql_kv_response":                            "admission.wait.durations.sql_kv.response",
	"admission_wait_durations_sql_kv_response_bucket":                     "admission.wait.durations.sql_kv.response.bucket",
	"admission_wait_durations_sql_kv_response_count":                      "admission.wait.durations.sql_kv.response.count",
	...
	"admission_wait_durations_sql_kv_response_sum":                        "admission.wait.durations.sql_kv.response.sum",
	...
	"admission_wait_durations_sql_sql_response_bucket":                    "admission.wait.durations.sql_sql.response.bucket",
	"admission_wait_durations_sql_sql_response_count":                     "admission.wait.durations.sql_sql.response.count",
	...
	"admission_wait_durations_sql_sql_response_sum":                       "admission.wait.durations.sql_sql.response.sum",
	...
	"admission_wait_queue_length_elastic_stores_bulk_low_pri":             "admission.wait_queue_length.elastic_stores.bulk_low_pri",
	...
	"admission_wait_queue_length_kv_stores_user_high_pri":                 "admission.wait_queue_length.kv_stores.user_high_pri",
	...
	"changefeed_admit_latency_bucket":                                     "changefeed.admit.latency.bucket",
	"changefeed_admit_latency_count":                                      "changefeed.admit.latency.count",
	"changefeed_admit_latency_sum":                                        "changefeed.admit.latency.sum",
	...
	"changefeed_buffer_entries_flush_aggregator":                          "changefeed.buffer_entries.flush.aggregator",
	"changefeed_buffer_entries_flush_rangefeed":                           "changefeed.buffer_entries.flush.rangefeed",
	...
	"changefeed_buffer_entries_kv_aggregator":                             "changefeed.buffer_entries.kv.aggregator",
	"changefeed_buffer_entries_kv_rangefeed":                              "changefeed.buffer_entries.kv.rangefeed",
	...
	"changefeed_buffer_entries_resolved_aggregator":                       "changefeed.buffer_entries.resolved.aggregator",
	"changefeed_buffer_entries_resolved_rangefeed":                        "changefeed.buffer_entries.resolved.rangefeed",
	...
	"changefeed_checkpoint_create_nanos":                                  "changefeed.checkpoint.create_nanos",
	"changefeed_checkpoint_create_nanos_bucket":                           "changefeed.checkpoint.create_nanos.bucket",
	"changefeed_checkpoint_create_nanos_count":                            "changefeed.checkpoint.create_nanos.count",
	"changefeed_checkpoint_create_nanos_sum":                              "changefeed.checkpoint.create_nanos.sum",
	"changefeed_checkpoint_hist_nanos":                                    "changefeed.checkpoint_hist",
	"changefeed_checkpoint_hist_nanos_bucket":                             "changefeed.checkpoint_hist.bucket",
	"changefeed_checkpoint_hist_nanos_count":                              "changefeed.checkpoint_hist.count",
	"changefeed_checkpoint_hist_nanos_sum":                                "changefeed.checkpoint_hist.sum",
	"changefeed_checkpoint_progress":                                      "changefeed.checkpoint_progress",
	"changefeed_checkpoint_span_count":                                    "changefeed.checkpoint.span_count",
	"changefeed_checkpoint_span_count_bucket":                             "changefeed.checkpoint.span_count.bucket",
	"changefeed_checkpoint_span_count_count":                              "changefeed.checkpoint.span_count.count",
	"changefeed_checkpoint_span_count_sum":                                "changefeed.checkpoint.span_count.sum",
	"changefeed_checkpoint_timestamp_count":                               "changefeed.checkpoint.timestamp_count",
	"changefeed_checkpoint_timestamp_count_bucket":                        "changefeed.checkpoint.timestamp_count.bucket",
	"changefeed_checkpoint_timestamp_count_count":                         "changefeed.checkpoint.timestamp_count.count",
	"changefeed_checkpoint_timestamp_count_sum":                           "changefeed.checkpoint.timestamp_count.sum",
	"changefeed_checkpoint_total_bytes":                                   "changefeed.checkpoint.total_bytes",
	"changefeed_checkpoint_total_bytes_bucket":                            "changefeed.checkpoint.total_bytes.bucket",
	"changefeed_checkpoint_total_bytes_count":                             "changefeed.checkpoint.total_bytes.count",
	"changefeed_checkpoint_total_bytes_sum":                               "changefeed.checkpoint.total_bytes.sum",
	...
	"changefeed_commit_latency_bucket":                                    "changefeed.commit.latency.bucket",
	"changefeed_commit_latency_count":                                     "changefeed.commit.latency.count",
	"changefeed_commit_latency_sum":                                       "changefeed.commit.latency.sum",
	...
	"changefeed_flush_hist_nanos_bucket":                                  "changefeed.flush_hist.bucket",
	"changefeed_flush_hist_nanos_count":                                   "changefeed.flush_hist.count",
	"changefeed_flush_hist_nanos_sum":                                     "changefeed.flush_hist.sum",
	...
	"changefeed_message_size_hist_bucket":                                 "changefeed.message.size.hist.bucket",
	"changefeed_message_size_hist_count":                                  "changefeed.message.size.hist.count",
	"changefeed_message_size_hist_sum":                                    "changefeed.message.size.hist.sum",
	"changefeed_messages_messages_pushback_nanos":                         "changefeed.messages.messages_pushback",
	"changefeed_network_bytes_in":                                         "changefeed.network.bytes_in",
	"changefeed_network_bytes_out":                                        "changefeed.network.bytes_out",
	"changefeed_nprocs_consume_event_nanos":                               "changefeed.nprocs_consume_event",
	"changefeed_nprocs_consume_event_nanos_bucket":                        "changefeed.nprocs_consume_event.bucket",
	"changefeed_nprocs_consume_event_nanos_count":                         "changefeed.nprocs_consume_event.count",
	"changefeed_nprocs_consume_event_nanos_sum":                           "changefeed.nprocs_consume_event.sum",
	"changefeed_nprocs_flush_nanos":                                       "changefeed.nprocs_flush",
	"changefeed_nprocs_flush_nanos_bucket":                                "changefeed.nprocs_flush.bucket",
	"changefeed_nprocs_flush_nanos_count":                                 "changefeed.nprocs_flush.count",
	"changefeed_nprocs_flush_nanos_sum":                                   "changefeed.nprocs_flush.sum",
	...
	"changefeed_parallel_io_queue_nanos_bucket":                           "changefeed.parallel_io_queue.bucket",
	"changefeed_parallel_io_queue_nanos_count":                            "changefeed.parallel_io_queue.count",
	"changefeed_parallel_io_queue_nanos_sum":                              "changefeed.parallel_io_queue.sum",
	...
	"changefeed_parallel_io_workers":                                      "changefeed.parallel_io_workers",
	...
	"changefeed_sink_batch_hist_nanos_bucket":                             "changefeed.sink_batch_hist.bucket",
	"changefeed_sink_batch_hist_nanos_count":                              "changefeed.sink_batch_hist.count",
	"changefeed_sink_batch_hist_nanos_sum":                                "changefeed.sink_batch_hist.sum",
	"changefeed_sink_errors":                                              "changefeed.sink_errors",
	...
	"changefeed_total_ranges":                                             "changefeed.total_ranges",
	"changefeed_usage_error_count":                                        "changefeed.usage.error_count",
	"changefeed_usage_query_duration":                                     "changefeed.usage.query_duration",
	"changefeed_usage_query_duration_bucket":                              "changefeed.usage.query_duration.bucket",
	"changefeed_usage_query_duration_count":                               "changefeed.usage.query_duration.count",
	"changefeed_usage_query_duration_sum":                                 "changefeed.usage.query_duration.sum",
	"changefeed_usage_table_bytes":                                        "changefeed.usage.table_bytes",
	"clock_offset_meannanos":                                              "clock.offset.meannanos",
	"clock_offset_medianabsdevnanos":                                      "clock_offset.medianabsdevnanos",
	"clock_offset_mediannanos":                                            "clock_offset.mediannanos",
	...
	"distsender_rangefeed_catchup_ranges_waiting_client_side":             "distsender.rangefeed.catchup_ranges_waiting_client_side",
	...
	"distsender_rangefeed_retry_unknown":                                  "distsender.rangefeed.retry.unknown",
	...
	"distsender_rpc_err_exclusionviolationerrtype":                        "distsender.rpc.err.exclusionviolationerrtype",
	...
	"distsender_rpc_excise_sent":                                          "distsender.rpc.excise.sent",
	"distsender_rpc_export_sent":                                          "distsender.rpc.export.sent",
	"distsender_rpc_flushlocktable_sent":                                  "distsender.rpc.flushlocktable.sent",
	...
	"gossip_messages_received":                                            "gossip.messages.received",
	"gossip_messages_sent":                                                "gossip.messages.sent",
	"intentage":                                                           "intentage",
	...
	"jobs_hot_ranges_logger_currently_idle":                               "jobs.hot_ranges_logger.currently_idle",
	"jobs_hot_ranges_logger_currently_paused":                             "jobs.hot_ranges_logger.currently_paused",
	"jobs_hot_ranges_logger_currently_running":                            "jobs.hot_ranges_logger.currently_running",
	"jobs_hot_ranges_logger_expired_pts_records":                          "jobs.hot_ranges_logger.expired_pts_records",
	"jobs_hot_ranges_logger_fail_or_cancel_completed":                     "jobs.hot_ranges_logger.fail_or_cancel_completed",
	"jobs_hot_ranges_logger_fail_or_cancel_retry_error":                   "jobs.hot_ranges_logger.fail_or_cancel_retry_error",
	"jobs_hot_ranges_logger_protected_age_sec":                            "jobs.hot_ranges_logger.protected_age_sec",
	"jobs_hot_ranges_logger_protected_record_count":                       "jobs.hot_ranges_logger.protected_record_count",
	"jobs_hot_ranges_logger_resume_completed":                             "jobs.hot_ranges_logger.resume_completed",
	"jobs_hot_ranges_logger_resume_failed":                                "jobs.hot_ranges_logger.resume_failed",
	"jobs_hot_ranges_logger_resume_retry_error":                           "jobs.hot_ranges_logger.resume_retry_error",
	...
	"jobs_inspect_currently_idle":                                         "jobs.inspect.currently_idle",
	"jobs_inspect_currently_paused":                                       "jobs.inspect.currently_paused",
	"jobs_inspect_currently_running":                                      "jobs.inspect.currently_running",
	"jobs_inspect_expired_pts_records":                                    "jobs.inspect.expired_pts_records",
	...
	"jobs_inspect_resume_failed":                                          "jobs.inspect.resume_failed",
	...
	"jobs_logical_replication_currently_idle":                             "jobs.logical_replication.currently_idle",
	"jobs_logical_replication_currently_paused":                           "jobs.logical_replication.currently_paused",
	"jobs_logical_replication_currently_running":                          "jobs.logical_replication.currently_running",
	"jobs_logical_replication_expired_pts_records":                        "jobs.logical_replication.expired_pts_records",
	"jobs_logical_replication_fail_or_cancel_completed":                   "jobs.logical_replication.fail_or_cancel_completed",
	"jobs_logical_replication_fail_or_cancel_retry_error":                 "jobs.logical_replication.fail_or_cancel_retry_error",
	"jobs_logical_replication_protected_age_sec":                          "jobs.logical_replication.protected_age_sec",
	"jobs_logical_replication_protected_record_count":                     "jobs.logical_replication.protected_record_count",
	"jobs_logical_replication_resume_completed":                           "jobs.logical_replication.resume_completed",
	"jobs_logical_replication_resume_failed":                              "jobs.logical_replication.resume_failed",
	"jobs_logical_replication_resume_retry_error":                         "jobs.logical_replication.resume_retry_error",
	...
	"jobs_row_level_ttl_num_delete_batch_retries":                         "jobs.row_level_ttl.num_delete_batch_retries",
	...
	"jobs_sql_activity_flush_currently_idle":                              "jobs.sql_activity_flush.currently_idle",
	"jobs_sql_activity_flush_currently_paused":                            "jobs.sql_activity_flush.currently_paused",
	"jobs_sql_activity_flush_currently_running":                           "jobs.sql_activity_flush.currently_running",
	"jobs_sql_activity_flush_expired_pts_records":                         "jobs.sql_activity_flush.expired_pts_records",
	"jobs_sql_activity_flush_fail_or_cancel_completed":                    "jobs.sql_activity_flush.fail_or_cancel_completed",
	"jobs_sql_activity_flush_fail_or_cancel_retry_error":                  "jobs.sql_activity_flush.fail_or_cancel_retry_error",
	"jobs_sql_activity_flush_protected_age_sec":                           "jobs.sql_activity_flush.protected_age_sec",
	"jobs_sql_activity_flush_protected_record_count":                      "jobs.sql_activity_flush.protected_record_count",
	"jobs_sql_activity_flush_resume_completed":                            "jobs.sql_activity_flush.resume_completed",
	"jobs_sql_activity_flush_resume_failed":                               "jobs.sql_activity_flush.resume_failed",
	"jobs_sql_activity_flush_resume_retry_error":                          "jobs.sql_activity_flush.resume_retry_error",
	"jobs_standby_read_ts_poller_currently_idle":                          "jobs.standby_read_ts_poller.currently_idle",
	"jobs_standby_read_ts_poller_currently_paused":                        "jobs.standby_read_ts_poller.currently_paused",
	"jobs_standby_read_ts_poller_currently_running":                       "jobs.standby_read_ts_poller.currently_running",
	"jobs_standby_read_ts_poller_expired_pts_records":                     "jobs.standby_read_ts_poller.expired_pts_records",
	"jobs_standby_read_ts_poller_fail_or_cancel_completed":                "jobs.standby_read_ts_poller.fail_or_cancel_completed",
	"jobs_standby_read_ts_poller_fail_or_cancel_retry_error":              "jobs.standby_read_ts_poller.fail_or_cancel_retry_error",
	"jobs_standby_read_ts_poller_protected_age_sec":                       "jobs.standby_read_ts_poller.protected_age_sec",
	"jobs_standby_read_ts_poller_protected_record_count":                  "jobs.standby_read_ts_poller.protected_record_count",
	"jobs_standby_read_ts_poller_resume_completed":                        "jobs.standby_read_ts_poller.resume_completed",
	"jobs_standby_read_ts_poller_resume_failed":                           "jobs.standby_read_ts_poller.resume_failed",
	"jobs_standby_read_ts_poller_resume_retry_error":                      "jobs.standby_read_ts_poller.resume_retry_error",
	...
	"kv_closed_timestamp_policy_change":                                                    "kv.closed_timestamp.policy_change",
	"kv_closed_timestamp_policy_lag_by_cluster_setting":                                    "kv.closed_timestamp.policy.lag_by_cluster_setting",
	"kv_closed_timestamp_policy_latency_info_missing":                                      "kv.closed_timestamp.policy_latency_info_missing",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_equal_or_greater_than_300ms": "kv.closed_timestamp.policy.lead_for_global_reads_latency_equal_or_greater_than_300ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_100ms":             "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_100ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_120ms":             "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_120ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_140ms":             "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_140ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_160ms":             "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_160ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_180ms":             "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_180ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_200ms":             "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_200ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_20ms":              "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_20ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_220ms":             "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_220ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_240ms":             "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_240ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_260ms":             "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_260ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_280ms":             "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_280ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_300ms":             "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_300ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_40ms":              "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_40ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_60ms":              "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_60ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_latency_less_than_80ms":              "kv.closed_timestamp.policy.lead_for_global_reads_latency_less_than_80ms",
	"kv_closed_timestamp_policy_lead_for_global_reads_with_no_latency_info":                "kv.closed_timestamp.policy.lead_for_global_reads_with_no_latency_info",
	...
	"kv_concurrency_locks_shed_due_to_memory_limit":                                        "kv.concurrency.locks_shed_due_to_memory_limit",
	...
	"kv_concurrency_num_lock_shed_due_to_memory_limit_events":                              "kv.concurrency.num_lock_shed_due_to_memory_limit_events",
	"kv_loadsplitter_cleardirection":                                                       "kv.loadsplitter.cleardirection",
	...
	"kv_rangefeed_closed_timestamp_slow_ranges_cancelled":                                  "kv.rangefeed.closed_timestamp.slow_ranges.cancelled",
	...
	"kv_rangefeed_unbuffered_registrations":                                                "kv.rangefeed.unbuffered_registrations",
	...
	"kvflowcontrol_eval_wait_elastic_duration":                                             "kvflowcontrol.eval_wait.elastic.duration",
	"kvflowcontrol_eval_wait_elastic_duration_bucket":                                      "kvflowcontrol.eval_wait.elastic.duration.bucket",
	"kvflowcontrol_eval_wait_elastic_duration_count":                                       "kvflowcontrol.eval_wait.elastic.duration.count",
	"kvflowcontrol_eval_wait_elastic_duration_sum":                                         "kvflowcontrol.eval_wait.elastic.duration.sum",
	"kvflowcontrol_eval_wait_elastic_requests_admitted":                                    "kvflowcontrol.eval_wait.elastic.requests.admitted",
	"kvflowcontrol_eval_wait_elastic_requests_bypassed":                                    "kvflowcontrol.eval_wait.elastic.requests.bypassed",
	"kvflowcontrol_eval_wait_elastic_requests_errored":                                     "kvflowcontrol.eval_wait.elastic.requests.errored",
	"kvflowcontrol_eval_wait_elastic_requests_waiting":                                     "kvflowcontrol.eval_wait.elastic.requests.waiting",
	"kvflowcontrol_eval_wait_regular_duration":                                             "kvflowcontrol.eval_wait.regular.duration",
	"kvflowcontrol_eval_wait_regular_duration_bucket":                                      "kvflowcontrol.eval_wait.regular.duration.bucket",
	"kvflowcontrol_eval_wait_regular_duration_count":                                       "kvflowcontrol.eval_wait.regular.duration.count",
	"kvflowcontrol_eval_wait_regular_duration_sum":                                         "kvflowcontrol.eval_wait.regular.duration.sum",
	"kvflowcontrol_eval_wait_regular_requests_admitted":                                    "kvflowcontrol.eval_wait.regular.requests.admitted",
	"kvflowcontrol_eval_wait_regular_requests_bypassed":                                    "kvflowcontrol.eval_wait.regular.requests.bypassed",
	"kvflowcontrol_eval_wait_regular_requests_errored":                                     "kvflowcontrol.eval_wait.regular.requests.errored",
	"kvflowcontrol_eval_wait_regular_requests_waiting":                                     "kvflowcontrol.eval_wait.regular.requests.waiting",
	"kvflowcontrol_range_controller_count":                                                 "kvflowcontrol.range_controller.count",
	"kvflowcontrol_send_queue_bytes":                                                       "kvflowcontrol.send_queue.bytes",
	"kvflowcontrol_send_queue_count":                                                       "kvflowcontrol.send_queue.count",
	"kvflowcontrol_send_queue_prevent_count":                                               "kvflowcontrol.send_queue.prevent.count",
	"kvflowcontrol_send_queue_scheduled_deducted_bytes":                                    "kvflowcontrol.send_queue.scheduled.deducted_bytes",
	"kvflowcontrol_send_queue_scheduled_force_flush":                                       "kvflowcontrol.send_queue.scheduled.force_flush",
	"kvflowcontrol_streams_eval_elastic_blocked_count":                                     "kvflowcontrol.streams.eval.elastic.blocked_count",
	"kvflowcontrol_streams_eval_elastic_total_count":                                       "kvflowcontrol.streams.eval.elastic.total_count",
	"kvflowcontrol_streams_eval_regular_blocked_count":                                     "kvflowcontrol.streams.eval.regular.blocked_count",
	"kvflowcontrol_streams_eval_regular_total_count":                                       "kvflowcontrol.streams.eval.regular.total_count",
	"kvflowcontrol_streams_send_elastic_blocked_count":                                     "kvflowcontrol.streams.send.elastic.blocked_count",
	"kvflowcontrol_streams_send_elastic_total_count":                                       "kvflowcontrol.streams.send.elastic.total_count",
	"kvflowcontrol_streams_send_regular_blocked_count":                                     "kvflowcontrol.streams.send.regular.blocked_count",
	"kvflowcontrol_streams_send_regular_total_count":                                       "kvflowcontrol.streams.send.regular.total_count",
	"kvflowcontrol_tokens_eval_elastic_available":                                          "kvflowcontrol.tokens.eval.elastic.available",
	"kvflowcontrol_tokens_eval_elastic_deducted":                                           "kvflowcontrol.tokens.eval.elastic.deducted",
	"kvflowcontrol_tokens_eval_elastic_returned":                                           "kvflowcontrol.tokens.eval.elastic.returned",
	"kvflowcontrol_tokens_eval_elastic_returned_disconnect":                                "kvflowcontrol.tokens.eval.elastic.returned.disconnect",
	"kvflowcontrol_tokens_eval_elastic_unaccounted":                                        "kvflowcontrol.tokens.eval.elastic.unaccounted",
	"kvflowcontrol_tokens_eval_regular_available":                                          "kvflowcontrol.tokens.eval.regular.available",
	"kvflowcontrol_tokens_eval_regular_deducted":                                           "kvflowcontrol.tokens.eval.regular.deducted",
	"kvflowcontrol_tokens_eval_regular_returned":                                           "kvflowcontrol.tokens.eval.regular.returned",
	"kvflowcontrol_tokens_eval_regular_returned_disconnect":                                "kvflowcontrol.tokens.eval.regular.returned.disconnect",
	"kvflowcontrol_tokens_eval_regular_unaccounted":                                        "kvflowcontrol.tokens.eval.regular.unaccounted",
	"kvflowcontrol_tokens_send_elastic_available":                                          "kvflowcontrol.tokens.send.elastic.available",
	"kvflowcontrol_tokens_send_elastic_deducted":                                           "kvflowcontrol.tokens.send.elastic.deducted",
	"kvflowcontrol_tokens_send_elastic_deducted_force_flush_send_queue":                    "kvflowcontrol.tokens.send.elastic.deducted.force_flush_send_queue",
	"kvflowcontrol_tokens_send_elastic_deducted_prevent_send_queue":                        "kvflowcontrol.tokens.send.elastic.deducted.prevent_send_queue",
	"kvflowcontrol_tokens_send_elastic_returned":                                           "kvflowcontrol.tokens.send.elastic.returned",
	"kvflowcontrol_tokens_send_elastic_returned_disconnect":                                "kvflowcontrol.tokens.send.elastic.returned.disconnect",
	"kvflowcontrol_tokens_send_elastic_unaccounted":                                        "kvflowcontrol.tokens.send.elastic.unaccounted",
	"kvflowcontrol_tokens_send_regular_available":                                          "kvflowcontrol.tokens.send.regular.available",
	"kvflowcontrol_tokens_send_regular_deducted":                                           "kvflowcontrol.tokens.send.regular.deducted",
	"kvflowcontrol_tokens_send_regular_deducted_prevent_send_queue":                        "kvflowcontrol.tokens.send.regular.deducted.prevent_send_queue",
	"kvflowcontrol_tokens_send_regular_returned":                                           "kvflowcontrol.tokens.send.regular.returned",
	"kvflowcontrol_tokens_send_regular_returned_disconnect":                                "kvflowcontrol.tokens.send.regular.returned.disconnect",
	"kvflowcontrol_tokens_send_regular_unaccounted":                                        "kvflowcontrol.tokens.send.regular.unaccounted",
	"lastupdatenanos":                                                     "lastupdatenanos",
	"leases_epoch":                                                        "leases.epoch",
	"leases_error":                                                        "leases.error",
	"leases_expiration":                                                   "leases.expiration",
	"leases_leader":                                                       "leases.leader",
	...
	"leases_transfers_locks_written":                                      "leases.transfers.locks_written",
	...
	"log_otlp_sink_grpc_transparent_retries":                              "log.otlp.sink.grpc.transparent_retries",
	"log_otlp_sink_write_attempts":                                        "log.otlp.sink.write.attempts",
	"log_otlp_sink_write_errors":                                          "log.otlp.sink.write.errors",
	"node_id":                                                             "node_id",
	...
	"physical_replication_catchup_ranges":                                 "physical_replication.catchup_ranges",
	...
	"physical_replication_scanning_ranges":                                "physical_replication.scanning_ranges",
	...
	"queue_gc_info_transactionspangcprepared":                             "queue.gc.info.transactionspangcprepared",
	...
	"queue_replicate_enqueue_add":                                         "queue.replicate.enqueue.add",
	"queue_replicate_enqueue_failedprecondition":                          "queue.replicate.enqueue.failedprecondition",
	"queue_replicate_enqueue_noaction":                                    "queue.replicate.enqueue.noaction",
	"queue_replicate_enqueue_unexpectederror":                             "queue.replicate.enqueue.unexpectederror",
	"queue_replicate_nonvoterpromotions":                                  "queue.replicate.nonvoterpromotions",
	"queue_replicate_pending":                                             "queue.replicate.pending",
	"queue_replicate_priority_inversion_requeue":                          "queue.replicate.priority_inversion.requeue",
	"queue_replicate_priority_inversion_total":                            "queue.replicate.priority_inversion.total",
	...
	"queue_replicate_queue_full":                                          "queue.replicate.queue_full",
	...
	"raft_flows_entered_state_probe":                                      "raft.flows.entered.state_probe",
	"raft_flows_entered_state_replicate":                                  "raft.flows.entered.state_replicate",
	"raft_flows_entered_state_snapshot":                                   "raft.flows.entered.state_snapshot",
	"raft_flows_state_probe":                                              "raft.flows.state_probe",
	"raft_flows_state_replicate":                                          "raft.flows.state_replicate",
	"raft_flows_state_snapshot":                                           "raft.flows.state_snapshot",
	...
	"raft_rcvd_defortifyleader":                                           "raft.rcvd.defortifyleader",
	"raft_rcvd_dropped":                                                   "raft.rcvd.dropped",
	"raft_rcvd_dropped_bytes":                                             "raft.rcvd.dropped_bytes",
	"raft_rcvd_fortifyleader":                                             "raft.rcvd.fortifyleader",
	"raft_rcvd_fortifyleaderresp":                                         "raft.rcvd.fortifyleaderresp",
	...
	"ranges":                                                              "ranges",
	"ranges_decommissioning":                                              "ranges.decommissioning",
	"ranges_decommissioning_nudger_enqueue":                               "ranges.decommissioning.nudger.enqueue",
	"ranges_decommissioning_nudger_enqueue_failure":                       "ranges.decommissioning.nudger.enqueue.failure",
	"ranges_decommissioning_nudger_enqueue_success":                       "ranges.decommissioning.nudger.enqueue.success",
	"ranges_decommissioning_nudger_not_leaseholder_or_invalid_lease":      "ranges.decommissioning.nudger.not_leaseholder_or_invalid_lease",
	"ranges_decommissioning_nudger_process_failure":                       "ranges.decommissioning.nudger.process.failure",
	"ranges_decommissioning_nudger_process_success":                       "ranges.decommissioning.nudger.process.success",
	...
	"replicas_asleep":                                                     "replicas.asleep",
	...
	"replicas_cpunanospersecond":                                          "replicas.cpunanospersecond",
	"replicas_leaders":                                                    "replicas.leaders",
	"replicas_leaders_invalid_lease":                                      "replicas.leaders_invalid_lease",
	"replicas_leaders_not_fortified":                                      "replicas.leaders_not_fortified",
	...
	"round_trip_default_class_latency":                                    "round_trip_default_class_latency",
	"round_trip_default_class_latency_bucket":                             "round_trip_default_class_latency.bucket",
	"round_trip_default_class_latency_count":                              "round_trip_default_class_latency.count",
	"round_trip_default_class_latency_sum":                                "round_trip_default_class_latency.sum",
	"round_trip_latency":                                                  "round_trip.latency",
	"round_trip_latency_bucket":                                           "round_trip.latency.bucket",
	"round_trip_latency_count":                                            "round_trip.latency.count",
	"round_trip_latency_sum":                                              "round_trip.latency.sum",
	"round_trip_raft_class_latency":                                       "round_trip_raft_class_latency",
	"round_trip_raft_class_latency_bucket":                                "round_trip_raft_class_latency.bucket",
	"round_trip_raft_class_latency_count":                                 "round_trip_raft_class_latency.count",
	"round_trip_raft_class_latency_sum":                                   "round_trip_raft_class_latency.sum",
	"round_trip_rangefeed_class_latency":                                  "round_trip_rangefeed_class_latency",
	"round_trip_rangefeed_class_latency_bucket":                           "round_trip_rangefeed_class_latency.bucket",
	"round_trip_rangefeed_class_latency_count":                            "round_trip_rangefeed_class_latency.count",
	"round_trip_rangefeed_class_latency_sum":                              "round_trip_rangefeed_class_latency.sum",
	"round_trip_system_class_latency":                                     "round_trip_system_class_latency",
	"round_trip_system_class_latency_bucket":                              "round_trip_system_class_latency.bucket",
	"round_trip_system_class_latency_count":                               "round_trip_system_class_latency.count",
	"round_trip_system_class_latency_sum":                                 "round_trip_system_class_latency.sum",
	"rpc_batches_recv":                                                    "rpc.batches.recv",
	"rpc_client_bytes_egress":                                             "rpc.client.bytes.egress",
	"rpc_client_bytes_ingress":                                            "rpc.client.bytes.ingress",
	"rpc_connection_avg_round_trip_latency":                               "rpc.connection.avg_round_trip_latency",
	"rpc_connection_connected":                                            "rpc.connection.connected",
	...
	"rpc_connection_tcp_rtt":                                              "rpc.connection.tcp_rtt",
	...
	"rpc_method_excise_recv":                                              "rpc.method.excise.recv",
	"rpc_method_export_recv":                                              "rpc.method.export.recv",
	"rpc_method_flushlocktable_recv":                                      "rpc.method.flushlocktable.recv",
	...
	"schedules_BACKUP_last_completed_time_by_virtual_cluster":             "schedules.BACKUP.last_completed_time_by_virtual_cluster",
	...
	"sql_call_stored_proc_count":                                          "sql.call_stored_proc.count",
	"sql_call_stored_proc_count_internal":                                 "sql.call_stored_proc.count.internal",
	"sql_call_stored_proc_started_count":                                  "sql.call_stored_proc.started.count",
	"sql_call_stored_proc_started_count_internal":                         "sql.call_stored_proc.started.count.internal",
	...
	"sql_exec_latency_consistent":                                         "sql.exec.latency.consistent",
	"sql_exec_latency_consistent_bucket":                                  "sql.exec.latency.consistent.bucket",
	"sql_exec_latency_consistent_count":                                   "sql.exec.latency.consistent.count",
	"sql_exec_latency_consistent_internal":                                "sql.exec.latency.consistent.internal",
	"sql_exec_latency_consistent_internal_bucket":                         "sql.exec.latency.consistent.internal.bucket",
	"sql_exec_latency_consistent_internal_count":                          "sql.exec.latency.consistent.internal.count",
	"sql_exec_latency_consistent_internal_sum":                            "sql.exec.latency.consistent.internal.sum",
	"sql_exec_latency_consistent_sum":                                     "sql.exec.latency.consistent.sum",
	"sql_exec_latency_count":                                              "sql.exec.latency.count",
	"sql_exec_latency_detail":                                             "sql.exec.latency.detail",
	"sql_exec_latency_detail_bucket":                                      "sql.exec.latency.detail.bucket",
	"sql_exec_latency_detail_count":                                       "sql.exec.latency.detail.count",
	"sql_exec_latency_detail_internal":                                    "sql.exec.latency.detail.internal",
	"sql_exec_latency_detail_internal_bucket":                             "sql.exec.latency.detail.internal.bucket",
	"sql_exec_latency_detail_internal_count":                              "sql.exec.latency.detail.internal.count",
	"sql_exec_latency_detail_internal_sum":                                "sql.exec.latency.detail.internal.sum",
	"sql_exec_latency_detail_sum":                                         "sql.exec.latency.detail.sum",
	"sql_exec_latency_historical":                                         "sql.exec.latency.historical",
	"sql_exec_latency_historical_bucket":                                  "sql.exec.latency.historical.bucket",
	"sql_exec_latency_historical_count":                                   "sql.exec.latency.historical.count",
	"sql_exec_latency_historical_internal":                                "sql.exec.latency.historical.internal",
	"sql_exec_latency_historical_internal_bucket":                         "sql.exec.latency.historical.internal.bucket",
	"sql_exec_latency_historical_internal_count":                          "sql.exec.latency.historical.internal.count",
	"sql_exec_latency_historical_internal_sum":                            "sql.exec.latency.historical.internal.sum",
	"sql_exec_latency_historical_sum":                                     "sql.exec.latency.historical.sum",
	...
	"sql_leases_long_wait_for_initial_version":                            "sql.leases.long_wait_for_initial_version",
	...
	"sql_routine_select_started_count_internal":                           "sql.routine.select.started.count.internal",
	"sql_routine_update_count":                                            "sql.routine.update.count",
	"sql_routine_update_count_internal":                                   "sql.routine.update.count.internal",
	"sql_routine_update_started_count":                                    "sql.routine.update.started.count",
	"sql_routine_update_started_count_internal":                           "sql.routine.update.started.count.internal",
	...
	"sql_schema_changer_object_count":                                     "sql.schema_changer.object_count",
	...
	"sql_service_latency_consistent":                                      "sql.service.latency.consistent",
	"sql_service_latency_consistent_bucket":                               "sql.service.latency.consistent.bucket",
	"sql_service_latency_consistent_count":                                "sql.service.latency.consistent.count",
	"sql_service_latency_consistent_internal":                             "sql.service.latency.consistent.internal",
	"sql_service_latency_consistent_internal_bucket":                      "sql.service.latency.consistent.internal.bucket",
	"sql_service_latency_consistent_internal_count":                       "sql.service.latency.consistent.internal.count",
	"sql_service_latency_consistent_internal_sum":                         "sql.service.latency.consistent.internal.sum",
	"sql_service_latency_consistent_sum":                                  "sql.service.latency.consistent.sum",
	"sql_service_latency_count":                                           "sql.service.latency.count",
	"sql_service_latency_historical":                                      "sql.service.latency.historical",
	"sql_service_latency_historical_bucket":                               "sql.service.latency.historical.bucket",
	"sql_service_latency_historical_count":                                "sql.service.latency.historical.count",
	"sql_service_latency_historical_internal":                             "sql.service.latency.historical.internal",
	"sql_service_latency_historical_internal_bucket":                      "sql.service.latency.historical.internal.bucket",
	"sql_service_latency_historical_internal_count":                       "sql.service.latency.historical.internal.count",
	"sql_service_latency_historical_internal_sum":                         "sql.service.latency.historical.internal.sum",
	"sql_service_latency_historical_sum":                                  "sql.service.latency.historical.sum",
	...
	"sql_statement_timeout_count":                                         "sql.statement_timeout.count",
	"sql_statement_timeout_count_internal":                                "sql.statement_timeout.count.internal",
	...
	"sql_stats_ingester_num_processed":                                    "sql.stats.ingester.num_processed",
	"sql_stats_ingester_queue_size":                                       "sql.stats.ingester.queue_size",
	...
	"sql_transaction_timeout_count":                                       "sql.transaction_timeout.count",
	"sql_transaction_timeout_count_internal":                              "sql.transaction_timeout.count.internal",
	"sql_txn_abort_count":                                                 "sql.txn.abort.count",
	"sql_txn_abort_count_internal":                                        "sql.txn.abort.internal",
	"sql_txn_auto_retry_count":                                            "sql.txn.auto_retry.count",
	"sql_txn_auto_retry_count_internal":                                   "sql.txn.auto_retry.count.internal",
	...
	"sql_txn_commit_prepared_count":                                       "sql.txn.commit_prepared.count",
	"sql_txn_commit_prepared_count_internal":                              "sql.txn.commit_prepared.count.internal",
	"sql_txn_commit_prepared_started_count":                               "sql.txn.commit_prepared.started.count",
	"sql_txn_commit_prepared_started_count_internal":                      "sql.txn.commit_prepared.started.count.internal",
	...
	"sql_txn_prepare_count":                                               "sql.txn.prepare.count",
	"sql_txn_prepare_count_internal":                                      "sql.txn.prepare.count.internal",
	"sql_txn_prepare_started_count":                                       "sql.txn.prepare.started.count",
	"sql_txn_prepare_started_count_internal":                              "sql.txn.prepare.started.count.internal",
	"sql_txn_rollback_count":                                              "sql.txn.rollback.count",
	"sql_txn_rollback_count_internal":                                     "sql.txn.rollback.internal",
	"sql_txn_rollback_prepared_count":                                     "sql.txn.rollback_prepared.count",
	"sql_txn_rollback_prepared_count_internal":                            "sql.txn.rollback_prepared.count.internal",
	"sql_txn_rollback_prepared_started_count":                             "sql.txn.rollback_prepared.started.count",
	"sql_txn_rollback_prepared_started_count_internal":                    "sql.txn.rollback_prepared.started.count.internal",
	...
	"sql_vecindex_pending_splits_merges":                                  "sql.vecindex.pending_splits_merges",
	"sql_vecindex_successful_splits":                                      "sql.vecindex.successful_splits",
	...
	"storage_compactions_cancelled_bytes":                                 "storage.compactions.cancelled.bytes",
	"storage_compactions_cancelled_count":                                 "storage.compactions.cancelled.count",
	...
	"storage_compression_cr":                                              "storage.compression.cr",
	"storage_compression_minlz_bytes":                                     "storage.compression.minlz.bytes",
	"storage_compression_minlz_cr":                                        "storage.compression.minlz.cr",
	"storage_compression_none_bytes":                                      "storage.compression.none.bytes",
	"storage_compression_snappy_bytes":                                    "storage.compression.snappy.bytes",
	"storage_compression_snappy_cr":                                       "storage.compression.snappy.cr",
	"storage_compression_unknown_bytes":                                   "storage.compression.unknown.bytes",
	"storage_compression_zstd_bytes":                                      "storage.compression.zstd.bytes",
	"storage_compression_zstd_cr":                                         "storage.compression.zstd.cr",
	...
	"storage_disk_read_max_iops":                                          "storage.disk.read_max.iops",
	...
	"storage_disk_unhealthy_duration":                                     "storage.disk_unhealthy.duration",
	...
	"storage_disk_write_max_iops":                                         "storage.disk.write_max.iops",
	...
	"storage_initial_stats_complete":                                      "storage.initial_stats_complete",
	...
	"storage_iterator_category_abort_span_block_load_bytes":               "storage.iterator.category_abort_span.block_load.bytes",
	"storage_iterator_category_abort_span_block_load_cached_bytes":        "storage.iterator.category_abort_span.block_load.cached_bytes",
	"storage_iterator_category_abort_span_block_load_latency_sum":         "storage.iterator.category_abort_span.block_load.latency_sum",
	"storage_iterator_category_backup_block_load_bytes":                   "storage.iterator.category_backup.block_load.bytes",
	"storage_iterator_category_backup_block_load_cached_bytes":            "storage.iterator.category_backup.block_load.cached_bytes",
	"storage_iterator_category_backup_block_load_latency_sum":             "storage.iterator.category_backup.block_load.latency_sum",
	"storage_iterator_category_batch_eval_block_load_bytes":               "storage.iterator.category_batch_eval.block_load.bytes",
	"storage_iterator_category_batch_eval_block_load_cached_bytes":        "storage.iterator.category_batch_eval.block_load.cached_bytes",
	"storage_iterator_category_batch_eval_block_load_latency_sum":         "storage.iterator.category_batch_eval.block_load.latency_sum",
	"storage_iterator_category_crdb_unknown_block_load_bytes":             "storage.iterator.category_crdb_unknown.block_load.bytes",
	"storage_iterator_category_crdb_unknown_block_load_cached_bytes":      "storage.iterator.category_crdb_unknown.block_load.cached_bytes",
	"storage_iterator_category_crdb_unknown_block_load_latency_sum":       "storage.iterator.category_crdb_unknown.block_load.latency_sum",
	"storage_iterator_category_intent_resolution_block_load_bytes":        "storage.iterator.category_intent_resolution.block_load.bytes",
	"storage_iterator_category_intent_resolution_block_load_cached_bytes": "storage.iterator.category_intent_resolution.block_load.cached_bytes",
	"storage_iterator_category_intent_resolution_block_load_latency_sum":  "storage.iterator.category_intent_resolution.block_load.latency_sum",
	"storage_iterator_category_mvcc_gc_block_load_bytes":                  "storage.iterator.category_mvcc_gc.block_load.bytes",
	"storage_iterator_category_mvcc_gc_block_load_cached_bytes":           "storage.iterator.category_mvcc_gc.block_load.cached_bytes",
	"storage_iterator_category_mvcc_gc_block_load_latency_sum":            "storage.iterator.category_mvcc_gc.block_load.latency_sum",
	"storage_iterator_category_pebble_compaction_block_load_bytes":        "storage.iterator.category_pebble_compaction.block_load.bytes",
	"storage_iterator_category_pebble_compaction_block_load_cached_bytes": "storage.iterator.category_pebble_compaction.block_load.cached_bytes",
	"storage_iterator_category_pebble_compaction_block_load_latency_sum":  "storage.iterator.category_pebble_compaction.block_load.latency_sum",
	"storage_iterator_category_pebble_get_block_load_bytes":               "storage.iterator.category_pebble_get.block_load.bytes",
	"storage_iterator_category_pebble_get_block_load_cached_bytes":        "storage.iterator.category_pebble_get.block_load.cached_bytes",
	"storage_iterator_category_pebble_get_block_load_latency_sum":         "storage.iterator.category_pebble_get.block_load.latency_sum",
	"storage_iterator_category_pebble_ingest_block_load_bytes":            "storage.iterator.category_pebble_ingest.block_load.bytes",
	"storage_iterator_category_pebble_ingest_block_load_cached_bytes":     "storage.iterator.category_pebble_ingest.block_load.cached_bytes",
	"storage_iterator_category_pebble_ingest_block_load_latency_sum":      "storage.iterator.category_pebble_ingest.block_load.latency_sum",
	"storage_iterator_category_range_snap_block_load_bytes":               "storage.iterator.category_range_snap.block_load.bytes",
	"storage_iterator_category_range_snap_block_load_cached_bytes":        "storage.iterator.category_range_snap.block_load.cached_bytes",
	"storage_iterator_category_range_snap_block_load_latency_sum":         "storage.iterator.category_range_snap.block_load.latency_sum",
	"storage_iterator_category_rangefeed_block_load_bytes":                "storage.iterator.category_rangefeed.block_load.bytes",
	"storage_iterator_category_rangefeed_block_load_cached_bytes":         "storage.iterator.category_rangefeed.block_load.cached_bytes",
	"storage_iterator_category_rangefeed_block_load_latency_sum":          "storage.iterator.category_rangefeed.block_load.latency_sum",
	"storage_iterator_category_replication_block_load_bytes":              "storage.iterator.category_replication.block_load.bytes",
	"storage_iterator_category_replication_block_load_cached_bytes":       "storage.iterator.category_replication.block_load.cached_bytes",
	"storage_iterator_category_replication_block_load_latency_sum":        "storage.iterator.category_replication.block_load.latency_sum",
	"storage_iterator_category_scan_background_block_load_bytes":          "storage.iterator.category_scan_background.block_load.bytes",
	"storage_iterator_category_scan_background_block_load_cached_bytes":   "storage.iterator.category_scan_background.block_load.cached_bytes",
	"storage_iterator_category_scan_background_block_load_latency_sum":    "storage.iterator.category_scan_background.block_load.latency_sum",
	"storage_iterator_category_scan_regular_block_load_bytes":             "storage.iterator.category_scan_regular.block_load.bytes",
	"storage_iterator_category_scan_regular_block_load_cached_bytes":      "storage.iterator.category_scan_regular.block_load.cached_bytes",
	"storage_iterator_category_scan_regular_block_load_latency_sum":       "storage.iterator.category_scan_regular.block_load.latency_sum",
	"storage_iterator_category_unknown_block_load_bytes":                  "storage.iterator.category_unknown.block_load.bytes",
	"storage_iterator_category_unknown_block_load_cached_bytes":           "storage.iterator.category_unknown.block_load.cached_bytes",
	"storage_iterator_category_unknown_block_load_latency_sum":            "storage.iterator.category_unknown.block_load.latency_sum",
	...
	"storage_point_deletions_bytes":                                       "storage.point_deletions.bytes",
	"storage_queue_store_failures":                                        "storage.queue.store_failures",
	"storage_range_deletions_bytes":                                       "storage.range_deletions.bytes",
	...
	"storage_sstable_remote_bytes":                                        "storage.sstable.remote.bytes",
	"storage_sstable_remote_count":                                        "storage.sstable.remote.count",
	"storage_sstable_zombie_bytes":                                        "storage.sstable.zombie.bytes",
	"storage_value_separation_blob_files_count":                           "storage.value_separation.blob_files.count",
	"storage_value_separation_blob_files_size":                            "storage.value_separation.blob_files.size",
	"storage_value_separation_value_bytes_referenced":                     "storage.value_separation.value_bytes.referenced",
	"storage_value_separation_value_bytes_unreferenced":                   "storage.value_separation.value_bytes.unreferenced",
	"storage_value_separation_value_retrieval_count":                      "storage.value_separation.value_retrieval.count",
	...
	"storeliveness_callbacks_processing_duration":                         "storeliveness.callbacks.processing_duration",
	"storeliveness_callbacks_processing_duration_bucket":                  "storeliveness.callbacks.processing_duration.bucket",
	"storeliveness_callbacks_processing_duration_count":                   "storeliveness.callbacks.processing_duration.count",
	"storeliveness_callbacks_processing_duration_sum":                     "storeliveness.callbacks.processing_duration.sum",
	"storeliveness_heartbeat_failures":                                    "storeliveness.heartbeat.failures",
	"storeliveness_heartbeat_successes":                                   "storeliveness.heartbeat.successes",
	"storeliveness_message_handle_failures":                               "storeliveness.message_handle.failures",
	"storeliveness_message_handle_successes":                              "storeliveness.message_handle.successes",
	"storeliveness_support_for_stores":                                    "storeliveness.support_for.stores",
	...
	"storeliveness_transport_received":                                    "storeliveness.transport.received",
	"storeliveness_transport_send_dropped":                                "storeliveness.transport.send_dropped",
	"storeliveness_transport_send_queue_bytes":                            "storeliveness.transport.send_queue_bytes",
	"storeliveness_transport_send_queue_idle":                             "storeliveness.transport.send_queue_idle",
	"storeliveness_transport_send_queue_size":                             "storeliveness.transport.send_queue_size",
	"storeliveness_transport_sent":                                        "storeliveness.transport.sent",
	"subsume_locks_written":                                               "subsume.locks_written",
	...
	"sys_host_net_send_tcp_fast_retrans_segs":                             "sys.host.net.send.tcp.fast_retrans_segs",
	"sys_host_net_send_tcp_loss_probes":                                   "sys.host.net.send.tcp.loss_probes",
	"sys_host_net_send_tcp_retrans_segs":                                  "sys.host.net.send.tcp.retrans_segs",
	"sys_host_net_send_tcp_slow_start_retrans":                            "sys.host.net.send.tcp.slow_start_retrans",
	"sys_host_net_send_tcp_timeouts":                                      "sys.host.net.send.tcp_timeouts",
	"sys_rss":                                                             "sys.rss",
	...
	"tenant_sql_usage_estimated_cpu_seconds":                              "tenant.sql_usage.estimated_cpu_seconds",
	"tenant_sql_usage_estimated_kv_cpu_seconds":                           "tenant.sql_usage.estimated_kv_cpu_seconds",
	"tenant_sql_usage_estimated_replication_bytes":                        "tenant.sql_usage.estimated_replication_bytes",
	...
	"tenant_sql_usage_provisioned_vcpus":                                  "tenant.sql_usage.provisioned_vcpus",
	...
	"txn_count_limit_on_response":                                         "txn.count_limit_on_response",
	"txn_count_limit_rejected":                                            "txn.count_limit_rejected",
	...
	"txn_restarts_exclusionviolation":                                     "txn.restarts.exclusionviolation",
	...
	"txn_write_buffering_batches_fully_handled":                           "txn.write_buffering.batches.fully_handled",
	"txn_write_buffering_disabled_after_buffering":                        "txn.write_buffering.disabled_after_buffering",
	"txn_write_buffering_memory_limit_exceeded":                           "txn.write_buffering.memory_limit_exceeded",
	"txn_write_buffering_num_enabled":                                     "txn.write_buffering.num_enabled",
