...
// runSmearingSenderGoroutine is the goroutine that smears the heartbeats over
...
func (t *Transport) runSmearingSenderGoroutine(
...
func NewTransport(
	...
	if err := t.runSmearingSenderGoroutine(
		context.Background(),
		stopper,
		settings,
	); err != nil {
